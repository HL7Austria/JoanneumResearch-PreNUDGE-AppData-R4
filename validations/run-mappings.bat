...
malac-hd -s -m ..\input\maps\at-prenudge-sleep-quality-base.map -m ..\input\maps\at-prenudge-sleep-quality-mapping.map -ti ..\fsh-generated\resources\QuestionnaireResponse-sleep-quality-response-dissatisfied-example.json  -to 02_leep_quality_dissatisfied_obs.json
