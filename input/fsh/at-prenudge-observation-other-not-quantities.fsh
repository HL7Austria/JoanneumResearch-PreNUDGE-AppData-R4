Profile: AtPrenudgeObservationOtherNotQuantities
...
* value[x] 0..1
* value[x] only CodeableConcept or boolean or integer or Range or Ratio or SampledData or time or dateTime or Period